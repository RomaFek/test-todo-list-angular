...
describe('ModalService', () => {
    ...
    it('should open AddTaskComponent modal', () => {
        ...
        expect(dialog.open).toHaveBeenCalledWith(AddTaskComponent, jasmine.any(Object));
    });
    ...
    it('should open ProfileComponent modal', () => {
        ...
        expect(dialog.open).toHaveBeenCalledWith(ProfileComponent, jasmine.any(Object));
    });
    ...
    it('should open MiniTaskComponent modal', () => {
        spyOn(dialog, 'open').and.callThrough();
        const task: ITask = {id: 1, description: 'Test Task', collectionTask: 'Test Collection', endDate: '2023-10-19T08:45:00', isCompleted: false};
        modalService.openAddMiniTaskModal(task);
        expect(dialog.open).toHaveBeenCalledWith(MiniTaskComponent, jasmine.any(Object));
    });
