...
describe('EditCollectionComponent', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            ...
            providers: [
                {provide: CollectionArrayService, useValue: collectionArrayServiceSpy},
        ...
        component.task = {id: 1, description: 'Task 1', collectionTask: 'Collection1', endDate: '2023-10-19T08:45:00', isCompleted: false};
    });
    ...
    it('should toggle edit mode and update task', () => {
        ...
        expect(copyBDServiceSpy.updateTask).toHaveBeenCalledWith({...component.task, collectionTask: 'Collection2'});
    });
});
