...
describe('AddCollectModalComponent', () => {
    ...
    beforeEach(() => {
        ...
        collectionArrayServiceSpy = jasmine.createSpyObj('CollectionArrayService', ['setNewCollect']);
    ...
    it('should submit new collection', () => {
        ...
        expect(collectionArrayServiceSpy.setNewCollect).toHaveBeenCalledWith('New Collection');
