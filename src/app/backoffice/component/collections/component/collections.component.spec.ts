...
describe('CollectionsComponent', () => {
    ...
    beforeEach(async(() => {
        ...
        UniqCollectionServiceSpy = jasmine.createSpyObj(
            'UniqCollectionService',
            ['getUniqueCollectionTasks'],
        );
        ...
        TestBed.configureTestingModule({
            ...
            providers: [
                ...
                {
                    provide: UniqCollectionService,
                    useValue: UniqCollectionServiceSpy,
                },
            ],
